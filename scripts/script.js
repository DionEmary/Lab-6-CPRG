...
function recalculate(){
    ...
    if(modelName.innerHTML == "Model XYZ"){
        costLabel.innerHTML = duration.innerHTML * 100;
    } else {
        costLabel.innerHTML = duration.innerHTML * 213;
    }
}
...
function changeDuration() {
    ...
    duration.innerHTML = prompt("How long do you want to rent this robot for?")
    recalculate()
}
